        ...
        return (
            <div className="space-y-2">
                ...
                <p>
                    ...
                    GitHub: <a href={links.github} className="text-blue-400 underline"
                               target="_blank">github.com/harungecit</a>
                </p>
                <p>
                    <FaLinkedin className="inline-block text-blue-500 mr-2"/>
                    LinkedIn: <a href={links.linkedin} className="text-blue-400 underline"
                                 target="_blank">linkedin.com/in/harungecit</a>
                </p>
                <p>
                    <FaYoutube className="inline-block text-red-500 mr-2"/>
                    YouTube: <a href={links.youtube} className="text-blue-400 underline"
                                target="_blank">youtube.com/@harungecit</a>
                </p>
                <p>
                    <FaXTwitter className="inline-block text-black mr-2"/>
                ...
                <p>
                    ...
                    Telegram: <a href={links.telegram} className="text-blue-400 underline"
                                 target="_blank">t.me/harungecit</a>
                </p>
                <p>
                    <FaDiscord className="inline-block text-purple-500 mr-2"/>
                    Discord: <a href={links.discord} className="text-blue-400 underline"
                                target="_blank">discord.gg/harungecit</a>
                </p>
                <p>
                    <FaInstagram className="inline-block text-pink-500 mr-2"/>
                    Instagram: <a href={links.instagram} className="text-blue-400 underline"
                                  target="_blank">instagram.com/harungecit.dev</a>
                </p>
                <p>
                    <FaBluesky className="inline-block text-blue-400 mr-2"/>
                    Bluesky: <a href={links.bluesky} className="text-blue-400 underline"
                                target="_blank">bsky.app/profile/harungecit.bsky.social</a>
                </p>
                <p>
                    <FaMastodon className="inline-block text-gray-600 mr-2"/>
                    Mastodon: <a href={links.mastodon} className="text-blue-400 underline"
                                 target="_blank">mastodon.social/@harungecit</a>
                </p>
                <p>
                    <FaSteam className="inline-block text-gray-400 mr-2"/>
                    Steam: <a href={links.steam} className="text-blue-400 underline"
                              target="_blank">steamcommunity.com/id/gecitharun</a>
                </p>
            </div>
        );
    },
